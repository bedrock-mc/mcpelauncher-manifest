...
#
get_filename_component(filename "/Users/hashim/Coding/other/mcpelauncher-manifest/build-macos/_deps/nlohmann_json_ext-tmp/include.zip" ABSOLUTE)
get_filename_component(directory "/Users/hashim/Coding/other/mcpelauncher-manifest/build-macos/_deps/nlohmann_json_ext-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-nlohmann_json_ext${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-nlohmann_json_ext${i}")
