...
#
get_filename_component(filename "/Users/hashim/Coding/other/mcpelauncher-manifest/build-macos/_deps/glfw3_ext-tmp/446707b4d9558cd2ef3024622bad320728b974c2.zip" ABSOLUTE)
get_filename_component(directory "/Users/hashim/Coding/other/mcpelauncher-manifest/build-macos/_deps/glfw3_ext-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-glfw3_ext${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-glfw3_ext${i}")
