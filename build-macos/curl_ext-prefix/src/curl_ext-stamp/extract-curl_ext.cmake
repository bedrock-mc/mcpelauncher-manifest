...
#
get_filename_component(filename "/Users/hashim/Coding/other/mcpelauncher-manifest/build-macos/curl_ext-prefix/src/curl-8.0.1.tar.gz" ABSOLUTE)
get_filename_component(directory "/Users/hashim/Coding/other/mcpelauncher-manifest/build-macos/curl_ext-prefix/src/curl_ext" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-curl_ext${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-curl_ext${i}")
